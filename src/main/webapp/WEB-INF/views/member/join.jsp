...
<head>
	...
	<script>
		...
		$(document).ready(function () {
	        $("#postcodify_search_button").postcodifyPopUp(); //우편번호검색기->작동안함
	    });
...
<body>
    <div class="join_box">
        ...
        <form id="join_form" method="POST" action="/member/join">
            ...
            <p>
                <label> * 우편번호</label> <br>
                <input type="text" name="addr1" id="addr1" class="postcodify_postcode5" value="" />
                <A style="display:inline-block; width:60px; text-align: center; line-height: 30px; cursor: pointer;" id="postcodify_search_button">검색</A>
            </p>
            <p>
                <label> * 도로명주소</label>
                <input type="text" name="addr2" id="addr2" class="postcodify_address" value="" />
            </p>
            <p>
                <label> * 상세주소</label>
                <input type="text" name="addr3" id="addr3" class="postcodify_details" value="" />
            </p>
            <p>
