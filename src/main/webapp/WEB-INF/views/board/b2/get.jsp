                ...
                <div class="row">
                    ...
                    <div class="col-xl-9 content_wraper">
                        <p class="content_title text-left">
                         ...
                         <div class="row">
                            ...
                            <div class="col-xl-6 text-right">
                                <a class="a_list" href='/board2/list?page=${scri.page }'><button class = "btn btn-success round btn-sm ">목록</button></a>
                            </div>
                        ...
                        <div style="display: none;">
                            <form action="/board2/commentWrite" method="post"></form>
                        </div>
	...
	<script>
		...
		$(document).ready(function() {
            ...
            $("#modify").on('click', function() {
                location.href = '/board2/updateView?gNo=' + gNo;
            ...
            $("#remove").on('click', function() {
                ...
                location.href = '/board2/delete?gNo=' + gNo;
            ...
            $(".btn_gcRemove").on('click', function() {
            	...
            	location.href = '/board2/commentDelete?gcNo=' + target_gcNo 
            			+ '&gNo=' + query_gNo;
            ...
            if(isImg) {
            	var str = '<img src="/resources/uploadImgs/board2/' + isImg + '">';
