                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 content_profile_wrap">
                        <div>
                            ...
                            <c:if test="${writer.p_img != null}">
                            	<img src="/member/display?fileName=${writer.p_img }" >
                            </c:if>
                    ...
                    <div class="col-xl-9 content_wraper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 text-right">
                                <a class="a_list" href='/board3/list?page=${scri.page }'><button class = "btn btn-success round btn-sm ">목록</button></a>
                            </div>
                        ...
                        <div style="display: none;">
                            <form action="/board3/commentWrite" method="post"></form>
                        </div>
	...
	<script>
		...
		$(document).ready(function() {
            ...
            $("#modify").on('click', function() {
                location.href = '/board3/updateView?gNo=' + gNo;
            ...
            $("#remove").on('click', function() {
                ...
                location.href = '/board3/delete?gNo=' + gNo;
            ...
            $(".btn_gcRemove").on('click', function() {
            	...
            	location.href = '/board3/commentDelete?gcNo=' + target_gcNo 
            			+ '&gNo=' + query_gNo;
            ...
            if(isImg) {
            	var str = '<img src="/resources/uploadImgs/board3/' + isImg + '">';
