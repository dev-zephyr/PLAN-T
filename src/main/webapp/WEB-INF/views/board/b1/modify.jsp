        ...
        function uploadImg() {
            ...
            $.ajax({
                ...
                success : function(result) {
                    ...
                    var str = '<img src="/board/display?fileName=' + result.strName + '">';
                    ...
                    $(".image_container").find("img").css("width", "70%");
                    $(".image_container").find("img").css("height", "70%");
                        ...
                        <form method="post" action="/board/update">
                            ...
                            <textarea id="summernote" name="gContents" id="input_content">
                            	<div class="image_container">
                                    <c:if test="${update.gImg != null}">
                                        <img src="/board/display?fileName=${update.gImg}">
                                    </c:if>
                                </div>
