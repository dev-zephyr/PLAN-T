...
public class Board3Controller {
	...
	public String commentDelete(CommentVO commentVO, SearchCriteria scri, BoardVO vo) {
		...
		commentService.deleteComment(commentVO.getGcNo(), 3);
	...
	public ResponseEntity<Map<String, Object>> uploadImgPOST(MultipartFile[] uploadFile) {
		String uploadFolder = "c://project//Bitcamp_3_//src//main//webapp//resources//uploadImgs//board3";
		String sendFileName = "";
		String sendOrgName = "";
		String sendStrName = "";
	...
	public ResponseEntity<byte[]> getFile(String fileName) {
		File file = new File("c://project//Bitcamp_3_//src//main//webapp//resources//uploadImgs//board3//" + fileName);
